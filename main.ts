...
//1. method
    ...
    add_in_courses(addcourse:string)
    {
...
//1. method
    ...
    new_data(NAME:string,fatherNAME:string)
    {
...
//3.method
    ...
    enroll_course(id:number,coursess:string)
    {
...
//5. method
    ...
    pay_fee(id:number,amount:number)
    {
